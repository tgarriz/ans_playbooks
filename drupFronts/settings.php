...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'drupal_arba',
      'username' => 'drupal',
      'password' => 'CLV.fr0nt1',
      'host' => 'opendb02.test.arba.gov.ar',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = 'cV56wLuU3XVMOebT1ZZF0gmwta-yuQG5jEIy3o1ufKQ';
...
if(isset($_SERVER['ENV']) && $_SERVER['ENV'] == 'hml-front') {
        $base_url = 'https://web.test.arba.gov.ar';
}
if(isset($_SERVER['ENV']) && $_SERVER['ENV'] == 'hml-adm') {
        $base_url = 'https://drupadm.test.arba.gov.ar';
}
// Redis settings
$conf['redis_client_password'] = "ClaveSegura";
$conf['redis_client_interface'] = 'PhpRedis';
$conf['redis_client_host'] = '127.0.0.1';
$conf['lock_inc'] = 'profiles/arba/modules/contrib/redis/redis.lock.inc';
$conf['path_inc'] = 'profiles/arba/modules/contrib/redis/redis.path.inc';
$conf['cache_backends'][] = 'profiles/arba/modules/contrib/redis/redis.autoload.inc';
